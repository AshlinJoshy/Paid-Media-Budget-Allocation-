...
export default function CampaignGroup({
  ...
  return (
    <>
      ...
      <tr
        ref={setNodeRef}
        className={`group bg-white border-y border-gray-200 transition-all duration-200 ease-out ${isOver ? 'bg-blue-50/70 shadow-[inset_3px_0_0_0_rgb(59,130,246)]' : 'shadow-[inset_3px_0_0_0_rgb(229,231,235)] hover:shadow-[inset_3px_0_0_0_rgb(148,163,184)]'}`}
      ...
      >
        ...
        {/* Campaign name */}
        <td className="px-2 py-2.5 min-w-[200px]" colSpan={2}>
          <EditableCell
            value={campaign.name}
        ...
        {/* Totals — shown starting from Lines column onward */}
        ...
        <td className="px-2 py-2.5 text-right min-w-[110px]">
          <span className={`text-xs font-semibold tabular-nums ${totalBudget === 0 ? 'text-gray-400' : totalRemaining < 0 ? 'text-red-600' : 'text-emerald-700'}`}>
